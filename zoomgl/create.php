...
("options" =>array("regexp"=>"/^[a-zA-Z\s]+$/")))){
    $name_err = "Porfavor ingresar un nombre valido.";
} else{
    $name = $input_name;
}
...
if(empty($input_address)){
    $address_err = "Porfavor ingresar un correo valido.";
} else{
...
if(empty($name_err) && empty($address_er) && empty($salary_err)){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            // Recordes created successfully.  Redirect to landung page
...
<html lang="en">
    <head>
        ...
        <header>
            ...
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mt-5">Acerca de ti</h2>
                            <p>Llena el formulario para enviarte mas informacion a tu correo electronico como: Detalles de los lentes, costos,etc.</p>
        ...
        <div class="form-group">
            ...
            echo $address_err;?></span>
        </div>
        <div class="form-group">
            <label>Comentarios</label>
            <input type="text" name="salary" class="form-control <?php 
            echo(!empty($salary_err)) ? 'is-invalid' : '';
            ?>" value="<?php echo $salary; ?>">
            <span class="invalid-feedback"><?php 
            echo $salary_err;?></span>
